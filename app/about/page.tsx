...
export const metadata = createMetadata({
  title: "About",
  description:
    "NerveStack Solutions is an engineering-led software house — direct access to the people building your product, not an account-management layer.",
    ...
    <div className="py-16">
      ...
      <div className="mt-14 grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <Reveal className="rounded-2xl border border-border bg-card/60 p-6">
          ...
          <p className="mt-3 font-heading text-2xl font-semibold text-foreground">One point of contact.</p>
